...
public class Database {
		...
		public  Database() {
			Book b1 = new Book(4001,"Two States","Chetan Bhagat","Rupa Pubs",169.03);
			Book b2 = new Book(4002,"I Too Had a Love Story","Ravinder Singh ","Srishti Pubs",159.35);
			Book b3 = new Book(4003,"Just Friends","Sumrit Shahi","Mahaveer Pubs",125.63);
			Book b4 = new Book(4004,"Till The Last Breath","Durjoy Datta","Penguin Pubs",140.32);
			ts.add(b1);
			ts.add(b2);
			ts.add(b3);
			ts.add(b4);
